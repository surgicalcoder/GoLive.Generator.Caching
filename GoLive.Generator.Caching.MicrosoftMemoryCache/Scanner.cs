...
public class Scanner
{
    ...
    private static IEnumerable<MemberToGenerate> ConvertToMembers(INamedTypeSymbol classSymbol)
    {
        foreach (var member in classSymbol.GetMembers())
        {
            ...
            if (!attr.Any(e => e.AttributeClass.ToString() == "GoLive.Generator.Caching.MicrosoftMemoryCache.CacheAttribute"))
            {
                continue;
            }
            ...
            var cacheAttr = attr.FirstOrDefault(e => e.AttributeClass.ToString() == "GoLive.Generator.Caching.MicrosoftMemoryCache.CacheAttribute");
